...
<html lang="en">
     <head>
        ...
        <title>IT; Gorlz | Potato Corner</title>
...
<!------------- BODY ------------->
    ...
    <body class= "background">
        <section>
            <img alt="" class="logo" src="logo.png"> </i>

            <span>
                <p class="text-white">WORLD'S BEST</p>
                <p class="text-yellow">FLAVORED FRIES!</p>
            </span>

            <button type='button'class="button-admin" onclick="document.location='login.php'">ADMIN LOGIN</button>
        </section>
